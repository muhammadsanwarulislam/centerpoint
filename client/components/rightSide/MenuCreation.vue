    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mb-4">
      ...
      >
        ...
        <tbody>
          ...
          <tr
            v-else-if="!is_loading && menu_list.length === 0"
            class="bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 h-80"
          >
            <td colspan="5">
              <div class="flex justify-center">
          ...
          <div class="flex flex-wrap pr-6 pl-3">
            ...
            <div class="flex items-start pt-4 w-full sm:w-1/2 lg:w-1/2">
              ...
              <div class="flex flex-col items-start w-full">
                ...
                />
                <span
                  v-if="is_validation && form.component === ''"
                  class="text-red-500"
            ...
            <div class="flex items-start pt-4 w-full sm:w-1/2 lg:w-1/2">
              ...
              <div class="flex flex-col items-start w-full">
                ...
                />
                <span
                  v-if="is_validation && form.ordering === ''"
                  class="text-red-500"
                  >Please enter ordering
                </span>
            ...
            <div class="flex items-start pt-4 w-full sm:w-1/2 lg:w-1/2">
              ...
              <div class="flex flex-col items-start w-full">
                ...
                <span
                  v-if="is_validation && form.type === ''"
                  class="text-red-500"
                  >Please menu type</span
                >
              </div>
            </div>
            ...
            <div
              ...
              class="flex items-start pt-4 w-full sm:w-1/2 lg:w-1/2"
            >
              <label
                for="activity"
                class="w-56 block pl-3 pr-3 text-sm font-medium text-gray-900 dark:text-white"
              ...
              <div class="flex flex-col items-start w-full">
                ...
                >
                  ...
                  <option
                    v-for="(item, index) in menus_for_parent_selections"
                    :key="index"
                    :value="item.id"
                  >
                    {{ item.name }}
                ...
                <span
                  v-if="is_validation && form.parent_id === ''"
                  class="text-red-500"
